...
assert result.elements == [[0, 0], [
    0, 0]], 'Matrix Multiplication was wrong, should be [[0, 0], [0, 0]], but was {}'.format(result.elements)
...
assert result.elements == [[1, 2], [
    3, 7]], 'RREF #1 was wrong, should be [[1, 0], [0, 1]], but was {}'.format(result.elements)
print('RREF #1 Passed!')
...
assert result.elements == [[1, 0, 0.16], [
    0, 1, 1.5]], 'RREF #4 was wrong, should be [[1, 0, 0.16], [0, 1, 1.5]], but was {}'.format(result.elements)
print('RREF #4 Passed!')
...
assert result.elements == [
    [1, 0, -1], [0, 1, 2]], 'RREF #6 was wrong, should be [[1, 0, -1], [0, 1, 2]], but was {}'.format(result.elements)
print('RREF #6 Passed!')
