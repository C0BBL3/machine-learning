...
assert result.elements == [[1.0, 0.0, 0.16666666666666663], [0.0, 1.0, 1.5]], 'RREF #4 was wrong, should be [[1, 0, 0.16], [0, 1, 1.5]], but was {}'.format(result.elements)
print('RREF #4 Passed!')
...
assert result.elements == [[0, 0.2], [1, 0.6]], 'Inverse by minors #1 was wrong, should be [[[0, 0.2], [1, 0.6]], but was {}'.format(result.elements)
print('Inverse #1 Passed!')
