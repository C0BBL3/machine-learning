...
print('Linear Regressor Training RSS: ', linear_regressor.rss(training_data_array))
print('Linear Regressor Testing RSS: ', linear_regressor.rss(testing_data_array))
...
print('Quadratic Regressor Training RSS: ', quadratic_regressor.rss(training_data_array))
print('Quadratic Regressor Testing RSS: ', quadratic_regressor.rss(testing_data_array))
...
print('Cubic Regressor Training RSS: ', cubic_regressor.rss(training_data_array))
print('Cubic Regressor Testing RSS: ', cubic_regressor.rss(testing_data_array))
...
print('Quartic Regressor Training RSS: ', quartic_regressor.rss(training_data_array))
print('Quartic Regressor Testing RSS: ', quartic_regressor.rss(testing_data_array))
...
print('Quintic Regressor Training RSS: ', quintic_regressor.rss(training_data_array))
print('Quintic Regressor Testing RSS: ', quintic_regressor.rss(testing_data_array))
